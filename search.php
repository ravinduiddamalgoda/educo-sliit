...
<body>
    ...
    <?php 
        ...
        $data = $_GET["q"];
        // echo $data;
        $sql= "SELECT * from game  where Verification='A'  AND Name LIKE '%".$data."%'";
              ...
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
                    ...
                    <div class='thumb'><img width='200px' height='200px' src='".$row['Game_Directory']."images/thumb-300x300.png'></div>
                    <div><span class='gname'>".$row['Name']."</span><span class='gtype'>".$row['GType']."</span></div>
